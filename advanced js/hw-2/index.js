//Для проверки правильности работы кода,при наличии обшибки выполниться
// остаток кода, можно понять в чем причина.
// Есть возможность генерировать собственные ошибки.
